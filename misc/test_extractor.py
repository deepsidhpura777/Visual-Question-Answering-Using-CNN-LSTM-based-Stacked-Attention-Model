...
from keras.layers import Input,Reshape, Dense, Conv2D, MaxPooling2D, AveragePooling2D, ZeroPadding2D, Flatten, Activation, add
...
if __name__ == '__main__':
    ...
    im = cv2.resize(cv2.imread('coco.jpg'), (448,448)).astype(np.float32)
